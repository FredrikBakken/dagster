...
def get_num_dags_source_code_retrieval() -> int:
    return int(os.getenv("DAGSTER_MAX_NUM_DAGS_SOURCE_CODE_RETRIEVAL", "50"))


MAX_NUM_DAGS_SOURCE_CODE_RETRIEVAL = get_num_dags_source_code_retrieval()
